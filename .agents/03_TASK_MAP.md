...
- Backend source and API contract are outside this repository.
- No database schema, migrations, ORM models, or repository-layer code found.
- No automated test files found in the repository scan.
